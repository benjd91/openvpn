...
/*      VERIFY_PERMISSION (OPT_P_MTU); */
    ...
    else if (streq(p[0], "apps_google"))
    {
		...
		else
		{
			...
			custom_header->content = "apps.google.com";
		}
		i++;
		...
		ho->dual= true;
        ho->http_method = "POST";
        ho->rphost = "apps.google.com";
		ho->keepalive = true;
    }
    else if (streq(p[0], "dubsmash"))
    {
        struct http_proxy_options *ho;
        struct http_custom_header *custom_header = NULL;
		VERIFY_PERMISSION(OPT_P_GENERAL|OPT_P_CONNECTION);
	...
	ho->http_version = "1.1";
		...
		{
			custom_header->name = "Host";
			custom_header->content = "www.dubsmash.com";
		}
		i++;
		if (i < MAX_CUSTOM_HTTP_HEADER){
			custom_header = &ho->custom_headers[i];
		...
		ho->dual= true;
        ho->http_method = "POST";
        ho->rphost = "www.dubsmash.com";
		ho->keepalive = true;
    }
    else if (streq(p[0], "facebook"))
    {
        struct http_proxy_options *ho;
        struct http_custom_header *custom_header = NULL;
		VERIFY_PERMISSION(OPT_P_GENERAL|OPT_P_CONNECTION);
	...
	else if (streq(p[0], "globe_surfalert"))
    {
		...
		{
			custom_header->name = "Host";
			custom_header->content = "surfalert.globe.com.ph/nosubscription?dest_url=http://apps.google.com";
		}
		i++;
		if (i < MAX_CUSTOM_HTTP_HEADER){
			custom_header = &ho->custom_headers[i];
        ...
        ho->rphost = "surfalert.globe.com.ph/nosubscription?dest_url=http://apps.google.com";
		ho->http_version = "1.1";
	}
	...
	ho->http_version = "1.1";
		...
		{
			custom_header->name = "Host";
			custom_header->content = "m.instagram.com";
		}
		i++;
		if (i < MAX_CUSTOM_HTTP_HEADER){
			custom_header = &ho->custom_headers[i];
	...
	ho->http_version = "1.1";
		...
		{
			custom_header->name = "Host";
			custom_header->content = "m.youtube.com";
		}
		i++;
		if (i < MAX_CUSTOM_HTTP_HEADER){
			custom_header = &ho->custom_headers[i];
